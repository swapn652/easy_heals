  ...
  return (
    <div 
      ...
      className="
        ...
        border-text-light"
      >
      <img src={imageSrc} className="2xl:h-[15em] xl:h-[13.5em] lg:h-[10.7em] md:h-[12em] rounded-tl-lg rounded-tr-lg" alt={name} />
      <div className="mt-2 flex flex-col items-center font-[Poppins] font-[500]">
        <div className="2xl:text-[15px] xl:text-[13px] lg:text-[11px] sm:text-[15px] 3xs:text-[14px]">{name}</div>
        <div className="2xl:text-[13px] xl:text-[11px] lg:text-[9px] sm:text-[12px] 3xs:text-[11px] text-buttonColor">{specialization}</div>
      </div>
