    ...
    <div style={{boxShadow: "0px 2px 10px 0px #60606026"}} className="2xl:w-[26em] xl:w-[24em] lg:w-[19em] 2xl:h-[15.5em] xl:h-[13.5em] lg:h-[11em] border-[0.1px] border-text-light rounded-lg flex flex-col relative bg-white font-[Poppins]">
        ...
        <div className="flex flex-row h-[3em]">
            <div className="flex flex-col ml-6 2xl:w-[17em] xl:w-[15em] lg:w-[12em]">
                <div className="flex flex-row items-center">
                    ...
                    <div className="2xl:text-[15px] xl:text-[14px] lg:text-[11px] ml-2">{hospitalName1}</div>
                    <img src="./star_icon.svg" className="2xl:w-[0.8em] xl:w-[0.7em] lg:w-[0.5em] ml-2" />
                    <div className="2xl:text-[10px] xl:text-[9px] lg:text-[8px] ml-[0.4em]">4.1</div>
                </div>
                <div className="flex flex-row mt-2">
                    <img src="./location_icon.svg" className="2xl:w-[0.9em] xl:w-[0.8em] lg:w-[0.7em]" />
                    <span className="text-text-light 2xl:text-[13px] xl:text-[11px] lg:text-[9px] ml-2 font-[300]">{hospitalAddress1}</span>
                </div>
            </div>
        ...
        <div className="flex flex-row h-[4em] 2xl:mt-6 xl:mt-4 lg:mt-2">
            <div className="flex flex-col ml-6 2xl:w-[17em] xl:w-[15em] lg:w-[12em]">
                <div className="flex flex-row items-center">
                    <img src="./hospital_icon.svg" className="2xl:w-[1.2em] xl:w-[1.1em] lg:w-[0.9em] 2xl:-mt-[0.5em] xl:-mt-[0.4em] lg:-mt-[0.4em]"/>
                    <div className="2xl:text-[15px] xl:text-[14px] lg:text-[11px] ml-2">{hospitalName2}</div>
                    <img src="./star_icon.svg" className="2xl:w-[0.8em] xl:w-[0.7em] lg:w-[0.5em] ml-2" />
                    <div className="2xl:text-[10px] xl:text-[9px] lg:text-[8px] ml-[0.4em]">4.1</div>
                </div>
                <div className="flex flex-row mt-2">
                    <img src="./location_icon.svg" className="2xl:w-[0.9em] xl:w-[0.8em] lg:w-[0.7em]" />
                    <span className="text-text-light 2xl:text-[13px] xl:text-[11px] lg:text-[9px] ml-2 font-[300]">{hospitalAddress2}</span>
                </div>
            </div>
            <div className="flex flex-col">
                <div className="font-[300] 2xl:text-[12px] xl:text-[10px] lg:text-[9px] text-green2">
