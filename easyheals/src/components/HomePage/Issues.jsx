      ...
      <div className="3xl:mx-4">
        <Slider {...settings} className="flex md:mx-20 mx-10">
          <div className="mx-2"> {/* Add a gap between cards */}
            <img src="./issues/acne.svg" className="3xl:w-[28vw] 2xl:w-[26em] xl:w-[22em] lg:w-[17em] 2md:w-[19.5em] md:w-[18.5em] sm:w-[15em] xs:w-[14em] 2xs:w-[13em] 3xs:w-[12em] cursor-pointer"/>
          </div>
          <div className="mx-2"> {/* Add a gap between cards */}
            <img src="./issues/men_health.svg" className="3xl:w-[28vw] 2xl:w-[26em] xl:w-[22em] lg:w-[17em] 2md:w-[19.5em] md:w-[18.5em] sm:w-[15em] xs:w-[14em] 2xs:w-[13em] 3xs:w-[12em] cursor-pointer"/>
          </div>
          <div className="mx-2"> {/* Add a gap between cards */}
            <img src="./issues/acne.svg" className="3xl:w-[28vw] 2xl:w-[26em] xl:w-[22em] lg:w-[17em] 2md:w-[19.5em] md:w-[18.5em] sm:w-[15em] xs:w-[14em] 2xs:w-[13em] 3xs:w-[12em] cursor-pointer"/>
          </div>
